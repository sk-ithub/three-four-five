    ...
    <div style={{width:"100%",height:"100vh",background:P.olive,position:"relative",overflow:"hidden",fontFamily:FB}}>
      ...
      {(showMenu||showHelp)&&(<div style={{position:"fixed",inset:0,background:"rgba(44,44,44,0.55)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:100}} onClick={()=>{setShowMenu(false);setShowHelp(false)}}>
        <div onClick={e=>e.stopPropagation()} style={{background:P.cream,borderRadius:6,padding:sz==="sm"?"14px":"20px",maxWidth:280,width:"85%",color:P.dark,boxShadow:"4px 4px 0px rgba(0,0,0,0.08)",textAlign:"center"}}>
          {showHelp?(<div style={{width:{sm:"300px",md:"450px",lg:"550px"}[sz], margin:sz==="sm"?"0 -15px":"0 -60px", textAlign:"center"}}>
            <h3 style={{fontFamily:FD,fontSize:{sm:20,md:24,lg:28}[sz],margin:"0 0 20px"}}>How To Play</h3>
            <div style={{fontSize:{sm:10,md:11,lg:13}[sz],lineHeight:1.4,fontWeight:500,textAlign:"left",display:"flex",flexDirection:"column",gap:15}}>
              <div style={{display:"flex",gap:12,alignItems:"flex-start"}}><span style={{...tagS(P.cream),color:P.dark,minWidth:75,textAlign:"center",boxShadow:"2px 2px 0px rgba(0,0,0,0.1)"}}>SETUP</span><div style={{color:P.dark}}>Each player starts with a target number of tricks.<br/><strong>Trump Caller · 5</strong> &nbsp;|&nbsp; <strong>Cutter · 4</strong> &nbsp;|&nbsp; <strong>Dealer · 3</strong></div></div>
              <div style={{display:"flex",gap:12,alignItems:"flex-start"}}><span style={{...tagS(P.terra),minWidth:75,textAlign:"center"}}>TRICKS</span><div style={{color:P.dark}}>Each player plays one card. The highest card wins all three—that is one "trick."</div></div>
              <div style={{display:"flex",gap:12,alignItems:"flex-start"}}><span style={{...tagS(P.blue),minWidth:75,textAlign:"center"}}>TRUMP</span><div style={{color:P.dark}}>One suit is chosen as Trump. These cards beat any other suit, regardless of rank.</div></div>
              <div style={{display:"flex",gap:12,alignItems:"flex-start"}}><span style={{...tagS(P.dark),minWidth:75,textAlign:"center"}}>RULES</span><div style={{color:P.dark}}>You must follow the suit that was led. If you can't, you may play a Trump to win or discard another suit.</div></div>
              <div style={{display:"flex",gap:12,alignItems:"flex-start"}}><span style={{...tagS(P.olive),minWidth:75,textAlign:"center"}}>WINNING</span><div style={{color:P.dark}}>High card of the led suit wins, unless a Trump is played. The winner leads the next trick.</div></div>
              <div style={{display:"flex",gap:12,alignItems:"flex-start"}}><span style={{...tagS(P.gold),minWidth:75,textAlign:"center"}}>SCORING</span><div style={{color:P.dark}}><div>At the end of a round, if you missed your target, you must pay points to those who exceeded theirs.*</div><div style={{fontSize:10,color:`${P.dark}60`,marginTop:6,lineHeight:1.2}}>*Each player starts out with 19 points, to stay true to the original offline game.</div></div></div>
            </div>
            <div style={{display:"flex",justifyContent:"center",marginTop:30}}>
              <button onClick={()=>setShowHelp(false)} style={{...btnS(P.terra),padding:"12px 60px",fontSize:16,borderRadius:6}}>GOT IT</button>
            </div>
          </div>):(<><h3 style={{fontFamily:FD,fontSize:{sm:16,md:18,lg:20}[sz],margin:"0 0 12px"}}>Menu</h3><div style={{display:"flex",flexDirection:"column",gap:6,alignItems:"center"}}>
